...
export const projects = [
  {
    ...
    description:
      'An AI-powered medical chatbot providing users with personalized healthcare support across 16 specializations, with features like symptom checking, medication reminders, expert consultations, and emergency assist. The chatbot supports multilingual communication and voice input for accessibility.',
  ...
  },
  {
    ...
    description:
      'An advanced machine learning application for real-time vehicle detection and classification, utilizing YOLO algorithm for accurate and efficient results.',
  ...
  },
  {
    ...
    description:
      'This tool, developed as part of the Contract Risk Assessment Hackathon, focuses on using Natural Language Processing (NLP) to analyze and extract key clauses from construction contract documents. The tool answers specific queries about contract details, providing concise summaries and insights.',
  ...
  },
  {
    title: 'Talaash AI',
    description:
      "Talaash AI is an innovative, AI-powered education platform designed to enhance learning experiences for students preparing for competitive exams. With features like Topper's Evaluation, Quiz Generation, Mindmap Creation, and a Career Hub, Talaash AI is your personal education sidekick, providing tailored support for academic success.",
...
export const experiences = [
  ...
  },
  {
    ...
    description:
      'Contributing to open-source Bitcoin projects like Shopstr under expert mentorship, fostering high-impact work and building a career in the Bitcoin FOSS ecosystem.',
  ...
  },
  {
    ...
    description:
      'Spearheaded a payment escrow system, reducing manual processing by 40%. Utilized P2PK time-locked Cashu tokens to secure funds and implemented a new UI for dispute resolution, decreasing transaction-related support tickets by over 30%.',
  ...
  },
  {
    ...
    description:
      'Developed GTM strategy for Educhain, increasing adoption by 20%. Optimized UX with AI-driven features, improving engagement by 15%. Conducted market research, boosting signups by 25%.',
  ...
  },
  {
    ...
    description:
      'Contributed to BuddyTrail & Skillwise projects, focusing on web development and enhancing smart contract functionalities.',
  ...
  },
  {
    ...
    description:
      'Contributed 23 PRs (10 merged) to projects like Unialgo, EventTrakka & Year-in-Progress, focusing on web development & Python improvements.',
...
export const skills = {
  ...
  soft: ['Problem Solving', 'Teamwork', 'Communication', 'Adaptability', 'Time Management', 'Critical Thinking'],
};
